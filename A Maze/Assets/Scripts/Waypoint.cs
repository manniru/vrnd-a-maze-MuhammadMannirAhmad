...
public class Waypoint : MonoBehaviour
{
	...
	private Color		_color_original			= new Color(1.0f, 1.0f, 0.0f, .5f);
	...
	public Color color_highlight				= new Color(0.8f, 0.8f, 1.0f, 0.125f);	
	...
	private void Idle()
	{
		...
		Color color				= Color.Lerp(_color_original, color_highlight, _animated_lerp);
	...
	{	
		...
		_color					= Color.Lerp(_color, color_highlight, lerp_clicked);
	}
